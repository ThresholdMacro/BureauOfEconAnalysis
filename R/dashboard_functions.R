...
hchartHA <- function(lngdata, mktname, citation, yaxistitle, rangeselect) {
  colors <- c("#f1c40f", "#2ecc71", "#9b59b6", "#e74c3c", "#2edaff",
              "#AC92ED","#9CED92","#ff69b4","#b69b59","#DF0ACA")
...
hchartHApct <- function(lngdata, mktname, citation, yaxistitle, rangeselect) {
  colors <- c("#f1c40f", "#2ecc71", "#9b59b6", "#e74c3c", "#2edaff",
              "#AC92ED","#9CED92","#ff69b4","#b69b59","#DF0ACA")
  colors_dt <- data.frame(metric = unique(lngdata$key),
                          color = colors[1:length(unique(lngdata$key))])
